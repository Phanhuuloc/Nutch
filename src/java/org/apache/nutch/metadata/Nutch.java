...
public interface Nutch {
  ...
  /** Listing Solr URL. */
  public static final String ARG_SOLR_LISTING = "solrlisting";
  /** Web Search Solr URL. */
  public static final String ARG_SOLR_WEB_SEARCH = "solrws";
  /** Movie Solr URL. */
  public static final String ARG_SOLR_MOVIE = "solrmovie";
