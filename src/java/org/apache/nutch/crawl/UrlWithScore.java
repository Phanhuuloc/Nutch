...
public final class UrlWithScore implements WritableComparable<UrlWithScore> {
  ...
  private IntWritable urlId;
  private Text sameUrlId;
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    score.readFields(in);
    urlId.readFields(in);
    sameUrlId.readFields(in);
    urlStatus.readFields(in);
  }
  ...
  public IntWritable getUrlId() {
	return urlId;
}

public void setUrlId(IntWritable urlId) {
	this.urlId = urlId;
}
...
public Text getSameUrlId() {
    return sameUrlId;
  }

  public void setSameUrlId(Text sameUrlId) {
    this.sameUrlId = sameUrlId;
  }
  
  public void setSameUrlId(String sameUrlId) {
    this.sameUrlId.set(sameUrlId);
  }
  
  public Text getUrlStatus() {
	    return urlStatus;
	  }

	  public void setUrlStatus(Text urlStatus) {
