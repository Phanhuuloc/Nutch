...
import org.apache.nutch.crawl.DbAtexpatsUpdaterJob;
...
public class AtexpatsUpdateJob extends DbAtexpatsUpdaterJob {

	public static Logger LOG = LoggerFactory.getLogger(AtexpatsUpdateJob.class);
	...
	public Map<String,Object> run(Map<String,Object> args) throws Exception {
		...
		currentJob = createIndexJob(getConf(), "update-atexpats", batchId);
	...
	public void indexSolr(String solrUrl, String batchId) throws Exception {
		LOG.info("UpdateAtexpatsJob: starting");
