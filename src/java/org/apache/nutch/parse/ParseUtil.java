...
public class ParseUtil extends Configured {
  ...
  public void process(String key, WebPage page) {
    ...
    org.apache.nutch.storage.ParseStatus pstatus = null;
    if(parse.getParseStatus() != null){
    	pstatus = (org.apache.nutch.storage.ParseStatus) parse.getParseStatus().clone();
    }
    ...
    if (ParseStatusUtils.isSuccess(pstatus)) {
      if (pstatus.getMinorCode() == ParseStatusCodes.SUCCESS_REDIRECT) {
        ...
        page.setParseBatchId(page.getBatchId());
